if exists(select 1 from sys.procedures where name = 'getCrowdsourcedResearchByPersonId')
begin 
	drop proc getCrowdsourcedResearchByPersonId
end
go

create proc getCrowdsourcedResearchByPersonId
	@person_id int
as
...
--exec getCrowdsourcedResearchByPersonId 132
